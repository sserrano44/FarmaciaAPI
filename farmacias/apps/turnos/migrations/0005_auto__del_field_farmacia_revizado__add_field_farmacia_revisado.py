...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Farmacia.revisado'
        db.add_column('turnos_farmacia', 'revisado', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Farmacia.revisado'
        db.delete_column('turnos_farmacia', 'revisado')
